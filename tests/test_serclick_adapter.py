...
def test_serclick_midday_ignition_maps_without_repricing_entry():
    source = pd.DataFrame([{
        ...
        "entry_raw_open": 4.00, "entry_price_slipped": 4.01,
...
def test_serclick_adapter_accepts_normalized_entry_price_raw_too():
    source = pd.DataFrame([{
        "symbol": "AAA", "date": "2026-08-28", "split": "forward",
        "population": "BOTH", "ignition_window": "10:30-15:00",
    ...
    out = adapt_serclick_ignitions(source)
    assert out.iloc[0]["entry_price_raw"] == 4.0


def test_serclick_morning_and_after_hours_are_distinct_variants():
    source = pd.DataFrame([
        {"symbol":"A","date":"2026-08-28","population":"BOTH","ignition_window":"09:30-10:30","timestamp":"2026-08-28 10:00-04:00","entry_timestamp":"2026-08-28 10:01-04:00","entry_raw_open":5.0,"entry_price_slipped":5.0125},
        {"symbol":"B","date":"2026-08-28","population":"BOTH","ignition_window":"16:00-20:00","timestamp":"2026-08-28 17:00-04:00","entry_timestamp":"2026-08-28 17:01-04:00","entry_raw_open":6.0,"entry_price_slipped":6.015},
    ])
    out = adapt_serclick_ignitions(source)
...
def test_serclick_non_both_midday_remains_control_variant():
    source = pd.DataFrame([{
        ...
        "timestamp":"2026-08-28 11:00-04:00","entry_timestamp":"2026-08-28 11:01-04:00",
        "entry_raw_open":5.0,"entry_price_slipped":5.0125,
    }])
    out = adapt_serclick_ignitions(source)
